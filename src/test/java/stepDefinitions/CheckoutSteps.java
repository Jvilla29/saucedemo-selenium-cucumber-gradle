...
public class CheckoutSteps {
    ...
    public void the_user_fills_out_the_form_with_and(String formName, String firstName, String lastName,
            String postalCode) {
    ...
    public void the_user_should_be_navigated_to_the_overview_page_to_see_the_total_price() {
        Assert.assertTrue(checkoutPage.isTotalPriceDisplayed(), "The total price is not visible on the Overview page");
    }
    ...
    public void the_user_should_see_the_message(String expectedMessage) {
        ...
        Assert.assertEquals(actualMessage, expectedMessage, "The thank you message does not match");
    }
}

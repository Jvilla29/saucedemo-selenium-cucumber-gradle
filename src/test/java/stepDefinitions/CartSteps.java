...
public class CartSteps {
    ...
    // public void the_user_clicks_the_button_for_the_sauce_labs_backpack(String
    // buttonText) {
    // inventoryPage.clickAddBackpackToCart();
    // }

    // @Then("the button text for the item should change to {string}")
    // public void the_button_text_for_the_item_should_change_to(String
    // expectedText) {
    // String actualText = inventoryPage.getRemoveButtonText();
    // Assert.assertEquals(actualText, expectedText, "The button text did not change
    // to Remove");
    // }
    ...
    // Assert.assertEquals(actualCount, expectedCount, "The shopping cart badge
    // count is incorrect");
    // }
    ...
    // Assert.assertTrue(cartPage.isBackpackInCart(), "The Sauce Labs Backpack is
    // not found on the Cart Page");
    // }
}
